...
### S_VEHICLE
Updated on 2026-04-14, 06:15:48
...
Updated on 2026-04-14, 06:15:49
...
| `TIMESTAMP_UTC` | TIMESTAMP_NTZ(6) | Coordinated Universal Time Timestamp |
| `STATUS` | NUMBER(38,0) | Based on status table for Fusion Result,needs to be amended if necessary |
| `NID_LRBG_C` | NUMBER(38,0) | Eurobalise Country Code of last relevant balise group |
| `NID_LRBG_BG` | NUMBER(38,0) | Eurobalise Balise Group ID of last relevant balise group |
| `NID_LRBG_PIG` | NUMBER(38,0) | Eurobalise Position in Group ID of last relevant balise group |
| `D_LRBG` | NUMBER(10,3) | Distance between the last relevant balise group and the estimated front end of the train [m] |
| `Q_DIRLRBG` | NUMBER(38,0) | Orientation of the train in relation to the direction of the last relevant balise group. 0=Reverse, 1=Nominal, 2=unkow, 3=Spare |
| `Q_DLRBG` | NUMBER(38,0) | Qualifier telling on which side of the last relevant balise group the estimated front end is. 0=Reverse, 1=Nominal, 2=unkow, 3=Spare |
| `Q_DIRTRAIN` | NUMBER(38,0) | Direction of train movement in relation to the last relevant balise group orientation. 0=Reverse, 1=Nominal, 2=unkow, 3=Spare |
| `TRAVELLED_DISTANCE` | NUMBER(10,3) | Cumulative, absolute, travelled distance since start of mission [m] |
| `SPEED` | NUMBER(6,3) | Absolute along track speed [m/s] |
| `ACCELERATION` | NUMBER(6,3) | Change of along track speed [m/s2] |
| `L_DOUBTOVER` | NUMBER(10,3) | Over-reading distance plus the Q_LOCACC of the last relevant balise group [m] |
| `L_DOUBTUNDER` | NUMBER(10,3) | Under-reading distance plus the Q_LOCACC of the last relevant balise group [m] |
| `SPEED_DOUBTOVER` | NUMBER(6,3) | Over-reading speed [m/s] |
| `SPEED_DOUBTUNDER` | NUMBER(6,3) | Under-reading speed [m/s] |
| `CREATED_TIMESTAMP` | TIMESTAMP_NTZ(6) | Timestamp of the row creation |

#### Comment
Fusion Result - Last relevant balise group (LRBG) Bound Coordinates
